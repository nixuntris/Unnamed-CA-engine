...
# REV
A physics engine that implements celullar automata combined with rigid bodies for per pixel simulation inspired by Falling Everything engine developed by Nolla Games and a sound simulation engine that changes depending on the material.
...
Implements simple rigid bodies. 
# Example usage:
    sand:
    weight = 3
    name = sand
...
# Technical details
They are logged on my website in the form of a series of blogs:
https://nixuntris.github.io/Private-Website/blueprint.html?id=physics_pbd